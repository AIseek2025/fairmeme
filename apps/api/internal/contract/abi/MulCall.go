...
var MulticallMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"function\",\"name\":\"aggregate\",\"inputs\":[{\"name\":\"calls\",\"type\":\"tuple[]\",\"internalType\":\"structMultiCall.Call[]\",\"components\":[{\"name\":\"target\",\"type\":\"address\",\"internalType\":\"address\"},{\"name\":\"callData\",\"type\":\"bytes\",\"internalType\":\"bytes\"}]}],\"outputs\":[{\"name\":\"blockNumber\",\"type\":\"uint256\",\"internalType\":\"uint256\"},{\"name\":\"returnData\",\"type\":\"bytes[]\",\"internalType\":\"bytes[]\"}],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"multiCall\",\"inputs\":[{\"name\":\"targets\",\"type\":\"address[]\",\"internalType\":\"address[]\"},{\"name\":\"data\",\"type\":\"bytes[]\",\"internalType\":\"bytes[]\"}],\"outputs\":[{\"name\":\"\",\"type\":\"bytes[]\",\"internalType\":\"bytes[]\"}],\"stateMutability\":\"view\"}]",
}
...
//
// Solidity: function multiCall(address[] targets, bytes[] data) view returns(bytes[])
func (_Multicall *MulticallCaller) MultiCall(opts *bind.CallOpts, targets []common.Address, data [][]byte) ([][]byte, error) {
	var out []interface{}
	err := _Multicall.contract.Call(opts, &out, "multiCall", targets, data)
...
//
// Solidity: function multiCall(address[] targets, bytes[] data) view returns(bytes[])
func (_Multicall *MulticallSession) MultiCall(targets []common.Address, data [][]byte) ([][]byte, error) {
	return _Multicall.Contract.MultiCall(&_Multicall.CallOpts, targets, data)
}

// MultiCall is a free data retrieval call binding the contract method 0xda5b4ffd.
//
// Solidity: function multiCall(address[] targets, bytes[] data) view returns(bytes[])
func (_Multicall *MulticallCallerSession) MultiCall(targets []common.Address, data [][]byte) ([][]byte, error) {
	return _Multicall.Contract.MultiCall(&_Multicall.CallOpts, targets, data)
}
