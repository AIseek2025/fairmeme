// import logo from './fairmemeLogo2.png';
...
import FairMeme from './FairMeme.png';
export { logo, search, xSpace, wallet, navIcon, solanaIcon, ethIcon, baseIcon, bnbIcon, FairMeme };
